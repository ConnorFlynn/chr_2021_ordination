...
median_cummulative_pressure = median(disadvantaged_high_pressure_counties$cummulative_pressure)
...
disadvantaged_high_pressure_counties <- disadvantaged_high_pressure_counties %>% 
 mutate(high_pressure = ifelse(cummulative_pressure > median_cummulative_pressure, c(1), c(0)))
...
sum_disadvantaged_high_pressure_counties_cummulative_pressure <- sum(disadvantaged_high_pressure_counties$cummulative_pressure)
sum_disadvantaged_high_pressure_counties_cummulative_pressure
...
total_pressure_per_county_disadvantaged_high_pressure <- sum_disadvantaged_high_pressure_counties_cummulative_pressure/disadvantaged_high_pressure_counties_number
...
median_cummulative_pressure_low_income <- median(low_income_counties$cummulative_pressure)
median_cummulative_pressure_low_income

median_cummulative_pressure <- median(normalized_pressures_chr_data$cummulative_pressure)
median_cummulative_pressure
```
...
median_cummulative_pressure_high <- median(high_pressure_counties$cummulative_pressure)
median_cummulative_pressure_high


sum_cummulative_pressure_high <- sum(high_pressure_counties$cummulative_pressure)
sum_cummulative_pressure_high

high_pressure_counties_number <- length(high_pressure_counties$fips_new)
high_pressure_counties_number

total_pressure_per_county_high_pressure <- sum_cummulative_pressure_high/high_pressure_counties_number
...
```{r}
# income_pressure_regression <- lm(cummulative_pressure ~ median_household_income, normalized_pressures_chr_data)
# 
# income_pressure_regression <- ggplot(data = normalized_pressures_chr_data, aes(x = median_household_income, y = cummulative_pressure)) +
...
```{r}
normalized_pressures_chr_data <- normalized_pressures_chr_data %>% 
  mutate(pressure_quartile = ntile(cummulative_pressure, 4))

```

```{r}
second_quartile_cummulative_pressure <- normalized_pressures_chr_data %>% 
  filter(pressure_quartile == 2) %>% 
  select(fips_new,
         cummulative_pressure,
         median_household_income,
...
summary(second_quartile_cummulative_pressure)
```
...
```{r}
third_quartile_cummulative_pressure <- normalized_pressures_chr_data %>% 
  filter(pressure_quartile == 3) %>% 
  select(fips_new,
         cummulative_pressure,
         median_household_income,
         primary_care_phys_ratio,
...
summary(third_quartile_cummulative_pressure)
```


```{r}
fourth_quartile_cummulative_pressure <- normalized_pressures_chr_data %>% 
  filter(pressure_quartile == 4) %>% 
  select(fips_new,
         cummulative_pressure,
         median_household_income,
         primary_care_phys_ratio,
...
summary(fourth_quartile_cummulative_pressure)
