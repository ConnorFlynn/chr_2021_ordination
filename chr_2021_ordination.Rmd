...
pre_process <- preProcess(all_pressures, method = c("range"))

normalized <- predict(pre_process, all_pressures)

summary(normalized)

sum(normalized$mean_pressure_ghg)
sum(normalized$mean_pressure_disturbance)
